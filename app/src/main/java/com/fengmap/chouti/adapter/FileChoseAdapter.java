...
public class FileChoseAdapter extends RecyclerView.Adapter<FileChoseAdapter.MyViewHolder> {
    Context context;
    List list;
    Integer layout;
    int[] to;

    public FileChoseAdapter(Context context, List<Object> list, Integer layout, int[] to) {
